...
var aboutMessage = "The JS is to import and cut song's subtitles by text.\n"+
...
function ImportToAe(array){
        ...
        for(var i=0; i<array.length; i++){
                var textBottomLayer = newComp.layers.addText(array[i].text);
                var textBottomProp = textBottomLayer.property("Source Text");
                var textBottomDocument = textBottomProp.value;
                textBottomDocument.fontSize = textStyleBottom.fontSize;
                textBottomDocument.font = textStyleBottom.font;
                textBottomDocument.applyFill = textStyleBottom.applyFill;
                textBottomDocument.fillColor = textStyleBottom.fillColor;
                textBottomDocument.applyStroke = textStyleBottom.applyStroke;
                textBottomDocument.justification = textStyleBottom.justification;
                textBottomDocument.tracking =textStyleBottom.tracking;
                textBottomProp.setValue(textBottomDocument);
                textBottomLayer.inPoint = array[i].inTime.totalSecond;
                textBottomLayer.outPoint = array[i].outTime.totalSecond;
                
                var textTopLayer  = newComp.layers.addText(array[i].text);
                var textTopProp = textTopLayer.property("Source Text");
                var textTopDocument = textTopProp.value;
                textTopDocument.fontSize = textStyleTop.fontSize;
                textTopDocument.font = textStyleTop.font;
                textTopDocument.applyFill = textStyleTop.applyFill;
                textTopDocument.fillColor = textStyleTop.fillColor;
                textTopDocument.applyStroke = textStyleTop.applyStroke;
                textTopDocument.justification = textStyleTop.justification;
                textTopDocument.tracking =textStyleTop.tracking;
                textTopProp.setValue(textTopDocument);
                textTopLayer.inPoint = array[i].inTime.totalSecond;
                textTopLayer.outPoint = array[i].outTime.totalSecond;
            }        
    }
